...
def venues():
  ...
  # data = Venue.query.group_by(Venue.id, Venue.state, Venue.city).all()
  ...
  for venue in areas:
      ...
      for venue_data in Venue.query.filter_by(city=venue['city'], state=venue['state']).all():
          ...
          venues_data = {
              ...
              #  # TODO: replace with real upcoming_shows data.
